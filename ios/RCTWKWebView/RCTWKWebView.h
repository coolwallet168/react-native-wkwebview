...
@property (nonatomic, copy) NSString *runJavaScriptAtDocumentStart;
@property (nonatomic, copy) NSString *runJavaScriptAtDocumentEnd;
@property (nonatomic, assign) BOOL runJavaScriptInMainFrameOnly;
